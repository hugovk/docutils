...
class Writer(writers.Writer):
    ...
    arguments_spec = (
        {'title': 'LaTeX-Specific Options',
         'description': None,
         'arguments': (
             {'flags': ('--documentclass',),
              'help': 'Specify LaTeX documentclass.  Default: "article".',
              "dest": "documentclass",
              "default": "article"},
             {'flags': ('--documentoptions',),
              'help': 'Specify document options.  Multiple options can be given, separated by commas.  Default: "a4paper".',
              "dest": "documentoptions",
              "default": 'a4paper'},
             {'flags': ('--footnote-references',),
              'help': 'Format for footnote references: one of "superscript" or "brackets".  Default: "superscript".',
              "dest": "footnote_references",
              "default": "superscript",
              'choices': ('superscript', 'brackets'),
              'metavar': '<format>',
              'overrides': 'trim_footnote_reference_space'},
             {'flags': ('--use-latex-citations',),
              'help': 'Use \\cite command for citations. (future default)',
              "dest": "use_latex_citations",
              "default": None,
              'action': 'store_true'},
             {'flags': ('--figure-citations',),
              'help': 'Use figure floats for citations (might get mixed with real figures). (provisional default)',
              "dest": "use_latex_citations",
              'action': 'store_false'},
             {'flags': ('--attribution',),
              'help': 'Format for block quote attributions: one of "dash" (em-dash prefix), "parentheses"/"parens", or "none".  Default: "dash".',
              "dest": "attribution",
              "default": "dash",
              'choices': ('dash', 'parentheses', 'parens', 'none'),
              'metavar': '<format>'},
             {'flags': ('--stylesheet',),
              'help': 'Specify LaTeX packages/stylesheets. A style is referenced with "\\usepackage" if extension is ".sty" or omitted and with "\\input" else.  Overrides previous --stylesheet and --stylesheet-path settings.',
              "dest": "stylesheet",
              "default": "",
              'metavar': '<file[,file,...]>',
             ...
             {'flags': ('--stylesheet-path',),
              'help': 'Comma separated list of LaTeX packages/stylesheets. Relative paths are expanded if a matching file is found in the --stylesheet-dirs. With --link-stylesheet, the path is rewritten relative to the output *.tex file. ',
              "dest": "stylesheet_path",
              "default": None,
              'metavar': '<file[,file,...]>',
              'overrides': 'stylesheet',
              "type": frontend.validate_comma_separated_list},
             {'flags': ('--link-stylesheet',),
              'help': 'Link to the stylesheet(s) in the output file. (default)',
              "dest": "embed_stylesheet",
              "default": False,
              'action': 'store_false'},
             {'flags': ('--embed-stylesheet',),
              'help': 'Embed the stylesheet(s) in the output file. Stylesheets must be accessible during processing. ',
              "dest": "embed_stylesheet",
              'action': 'store_true'},
             {'flags': ('--stylesheet-dirs',),
              'help': 'Comma-separated list of directories where stylesheets are found. Used by --stylesheet-path when expanding relative path arguments. Default: ".".',
              "dest": "stylesheet_dirs",
              "default": ('.',),
              'metavar': '<dir[,dir,...]>',
              "type": frontend.validate_comma_separated_list},
             {'flags': ('--latex-preamble',),
              'help': 'Customization by LaTeX code in the preamble. Default: select PDF standard fonts (Times, Helvetica, Courier).',
              "dest": "latex_preamble",
              "default": '% PDF Standard Fonts\n\\usepackage{mathptmx} % Times\n\\usepackage[scaled=.90]{helvet}\n\\usepackage{courier}'},
             {'flags': ('--template',),
              'help': 'Specify the template file. Default: "default.tex".',
              "dest": "template",
              "default": "default.tex",
              'metavar': '<file>'},
             {'flags': ('--use-latex-toc',),
              'help': 'Table of contents by LaTeX. (default)',
              "dest": "use_latex_toc",
              "default": True,
              'action': 'store_true'},
             {'flags': ('--use-docutils-toc',),
              'help': 'Table of contents by Docutils (without page numbers).',
              "dest": "use_latex_toc",
              'action': 'store_false'},
             {'flags': ('--use-part-section',),
              'help': 'Add parts on top of the section hierarchy.',
              "dest": "use_part_section",
              "default": False,
              'action': 'store_true'},
             {'flags': ('--use-docutils-docinfo',),
              'help': 'Attach author and date to the document info table. (default)',
              "dest": "use_latex_docinfo",
              "default": False,
              'action': 'store_false'},
             {'flags': ('--use-latex-docinfo',),
              'help': 'Attach author and date to the document title.',
              "dest": "use_latex_docinfo",
              'action': 'store_true'},
             {'flags': ('--topic-abstract',),
              'help': 'Typeset abstract as topic. (default)',
              "dest": "use_latex_abstract",
              "default": False,
              'action': 'store_false'},
             {'flags': ('--use-latex-abstract',),
              'help': "Use LaTeX abstract environment for the document's abstract.",
              "dest": "use_latex_abstract",
              'action': 'store_true'},
             {'flags': ('--hyperlink-color',),
              'help': 'Color of any hyperlinks embedded in text. Default: "blue" (use "false" to disable).',
              "dest": "hyperlink_color",
              "default": "blue"},
             {'flags': ('--hyperref-options',),
              'help': 'Additional options to the "hyperref" package.',
              "dest": "hyperref_options",
              "default": ""},
             {'flags': ('--compound-enumerators',),
              'help': 'Enable compound enumerators for nested enumerated lists (e.g. "1.2.a.ii").',
              "dest": "compound_enumerators",
              "default": False,
              'action': frontend._BooleanOptionalAction},
             {'flags': ('--section-prefix-for-enumerators',),
              'help': 'Enable section ("." subsection ...) prefixes for compound enumerators.  This has no effect without --compound-enumerators.',
              "dest": "section_prefix_for_enumerators",
              "default": None,
              'action': frontend._BooleanOptionalAction},
             {'flags': ('--section-enumerator-separator',),
              'help': 'Set the separator between section number and enumerator for compound enumerated lists.  Default: "-".',
              "dest": "section_enumerator_separator",
              "default": "-",
              'metavar': '<char>'},
             {'flags': ('--literal-block-env',),
              'help': 'When possible, use the specified environment for literal-blocks. Default: "" (fall back to "alltt").',
              "dest": "literal_block_env",
              "default": ""},
             {'flags': ('--use-verbatim-when-possible',),
              'help': 'Deprecated alias for "--literal-block-env=verbatim".',
              "dest": "use_verbatim_when_possible",
              "default": None,
              'action': 'store_true'},
             {'flags': ('--table-style',),
              'help': 'Table style. "standard" with horizontal and vertical lines, "booktabs" (LaTeX booktabs style) only horizontal lines above and below the table and below the header, or "borderless". Default: "standard"',
              "dest": "table_style",
              "default": ("standard",),
              'metavar': '<format>',
              'action': 'append',
              "type": frontend.validate_comma_separated_list,
              'choices': ('booktabs', 'borderless', 'colwidths-auto', 'nolines', 'standard')},
             {'flags': ('--graphicx-option',),
              'help': 'LaTeX graphicx package option. Possible values are "dvipdfmx", "dvips", "dvisvgm", "luatex", "pdftex", and "xetex".Default: "".',
              "dest": "graphicx_option",
              "default": ""},
             {'flags': ('--font-encoding',),
              'help': 'LaTeX font encoding. Possible values are "", "T1" (default), "OT1", "LGR,T1" or any other combination of options to the `fontenc` package. ',
              "dest": "font_encoding",
              "default": "T1"},
             {'flags': ('--reference-label',),
              'help': 'Per default the latex-writer puts the reference title into hyperreferences. Specify "ref*" or "pageref*" to get the section number or the page number.',
              "dest": "reference_label",
              "default": ""},
             {'flags': ('--use-bibtex',),
              'help': 'Specify style and database for bibtex, for example "--use-bibtex=mystyle,mydb1,mydb2".',
              "dest": "use_bibtex",
              "default": ""},
             {'flags': ('--legacy-class-functions',),
              'help': 'Use legacy functions with class value list for \\DUtitle and \\DUadmonition.',
              "dest": "legacy_class_functions",
              "default": False,
              'action': 'store_true'},
             {'flags': ('--new-class-functions',),
              'help': 'Use \\DUrole and "DUclass" wrappers for class values. Place admonition content in an environment. (default)',
              "dest": "legacy_class_functions",
              "default": False,
              'action': 'store_false'},
             {'flags': ('--legacy-column-widths',),
              'help': 'Use legacy algorithm to determine table column widths. (provisional default)',
              "dest": "legacy_column_widths",
              "default": None,
              'action': 'store_true'},
             {'flags': ('--new-column-widths',),
              'help': 'Use new algorithm to determine table column widths. (future default)',
              "dest": "legacy_column_widths",
              "default": None,
              'action': 'store_false'},
              # TODO: implement "latex footnotes" alternative
             {'flags': ('--docutils-footnotes',),
              'help': 'Footnotes with numbers/symbols by Docutils. (default) (The alternative, --latex-footnotes, is not implemented yet.)',
