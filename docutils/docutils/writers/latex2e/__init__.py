...
class Table:
    ...
    def get_opening(self, width=r'\linewidth'):
        ...
        if align and latex_type not in ("longtable", "longtable*"):
            ...
            opening = [fr'\begin{{{latex_type}}}{align}']
...
class LaTeXTranslator(nodes.NodeVisitor):
    ...
    def __init__(self, document, babel_class=Babel):
        ...
        if self.hyperlink_color in ('0', 'false', 'False', ''):
            ...
            self.hyperref_options = 'colorlinks=true,linkcolor={},urlcolor={}'.format(
        ...
        if self.settings.embed_stylesheet:
            ...
            if is_package:
                content = '\n'.join([r'\makeatletter',
                                     content,
                                     r'\makeatother'])
            return f'% embedded stylesheet: {path}\n{content}'
        # Link to style file:
        if is_package:
    ...
    def visit_enumerated_list(self, node):
        ...
        label = fr'{prefix}\{enumtype}{{{counter_name}}}{suffix}'
    ...
    def visit_image(self, node):
        ...
        self.out.append(f'\\includegraphics{options}{{{imagepath}}}')
