    ...
    arguments_spec = (
        {'title': 'ODF-Specific Options',
         ...
         'arguments': (
             ...
             {'flags': ('--table-border-thickness',),
              'help': 'Specify the thickness of table borders in thousands of a cm.  Default is 35.',
              "dest": "table_border_thickness",
              "default": None,
              'type': frontend.validate_nonnegative_int},
             {'flags': ('--add-syntax-highlighting',),
              'help': 'Add syntax highlighting in literal code blocks.',
              "dest": "add_syntax_highlighting",
              "default": False,
              'action': 'store_true'},
             {'flags': ('--no-syntax-highlighting',),
              'help': 'Do not add syntax highlighting in literal code blocks. (default)',
              "dest": "add_syntax_highlighting",
              'default': False,
              'action': 'store_false'},
             {'flags': ('--create-sections',),
              'help': 'Create sections for headers.  (default)',
              "dest": "create_sections",
              "default": True,
              'action': 'store_true'},
             {'flags': ('--no-sections',),
              'help': 'Do not create sections for headers.',
              "dest": "create_sections",
              "default": True,
              'action': 'store_false'},
             {'flags': ('--create-links',),
              ...
              'action': 'store_true'},
             {'flags': ('--no-links',),
              'help': 'Do not create links.  (default)',
              "dest": "create_links",
              "default": False,
              'action': 'store_false'},
             {'flags': ('--endnotes-end-doc',),
              'help': 'Generate endnotes at end of document, not footnotes at bottom of page.',
              "dest": "endnotes_end_doc",
              "default": False,
              'action': frontend._BooleanOptionalAction},
             {'flags': ('--generate-list-toc',),
              'help': 'Generate a bullet list table of contents, not an ODF/oowriter table of contents.',
              "dest": "generate_oowriter_toc",
              "default": True,
              'action': 'store_false'},
             {'flags': ('--generate-oowriter-toc',),
              'help': 'Generate an ODF/oowriter table of contents, not a bullet list. (default)',
              "dest": "generate_oowriter_toc",
              "default": True,
              'action': 'store_true'},
             {'flags': ('--custom-odt-header',),
              'help': 'Specify the contents of an custom header line.  See odf_odt writer documentation for details about special field character sequences.',
              "dest": "custom_header",
              "default": ""},
             {'flags': ('--custom-odt-footer',),
              'help': 'Specify the contents of an custom footer line.  See odf_odt writer documentation for details about special field character sequences.',
              "dest": "custom_footer",
              "default": ""}
         )},
    )
