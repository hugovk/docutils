...
<document source="test data">
    ...
    <literal_block source="test_parsers/test_rst/test_directives/includes/include5.rst" xml:space="preserve">
        In includes/include5.rst
        \n\
    ...
    <section ids="section-underline-too-short" names="section\\ underline\\ too\\ short">
        ...
        <block_quote>
            <paragraph>
                ...
                <problematic ids="problematic-5" refid="system-message-5">
                    *
                inline warning
            <system_message backrefs="problematic-5" ids="system-message-5" level="2" line="68" source="test_parsers/test_rst/test_directives/include10.rst" type="WARNING">
                <paragraph>
                    Inline emphasis start-string without end-string.
            <attribution>
                attribution with \n\
                <problematic ids="problematic-6" refid="system-message-6">
                    *
                inline warning
        <system_message backrefs="problematic-6" ids="system-message-6" level="2" line="70" source="test_parsers/test_rst/test_directives/include10.rst" type="WARNING">
            <paragraph>
                Inline emphasis start-string without end-string.
        <paragraph>
        ...
        <system_message level="3" line="76" source="%(source)s" type="ERROR">
            ...
            <literal_block xml:space="preserve">
                ...
                .. end of inclusion from "test_parsers/test_rst/test_directives/include10.rst"
...
============================= =============================
.. include:: data/include.rst .. include:: data/include.rst
============================= =============================
""",
"""\
<document source="test data">
