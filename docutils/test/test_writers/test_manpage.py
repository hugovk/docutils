...
class TestManpage(unittest.TestCase, docutils.SettingsSpec):
    ...
    def test_blank(self):
        case_input, case_expected = blank
        output = docutils.core.publish_string(
            source=case_input,
            reader_name='standalone', parser_name='restructuredtext',
            writer_name='manpage', settings_spec=self)
        self.assertEqual(output, case_expected)

    def test_hello(self):
        case_input, case_expected = hello
        output = docutils.core.publish_string(
            source=case_input,
            reader_name='standalone', parser_name='restructuredtext',
            writer_name='manpage', settings_spec=self)
    ...
    def test_simple(self):
        case_input, case_expected = simple
        output = docutils.core.publish_string(
            source=case_input,
            reader_name='standalone', parser_name='restructuredtext',
            writer_name='manpage', settings_spec=self)
    ...
    def test_table(self):
        case_input, case_expected = table
        output = docutils.core.publish_string(
            source=case_input,
            reader_name='standalone', parser_name='restructuredtext',
            writer_name='manpage', settings_spec=self)
    ...
    def test_option_group(self):
        case_input, case_expected = option_group
        output = docutils.core.publish_string(
            source=case_input,
            reader_name='standalone', parser_name='restructuredtext',
            writer_name='manpage', settings_spec=self)
    ...
    def test_definition_list(self):
        case_input, case_expected = definition_list
        output = docutils.core.publish_string(
            source=case_input,
            reader_name='standalone', parser_name='restructuredtext',
            writer_name='manpage', settings_spec=self)
    ...
    def test_cmd_line_options(self):
        case_input, case_expected = cmd_line_options
        output = docutils.core.publish_string(
            source=case_input,
            reader_name='standalone', parser_name='restructuredtext',
            writer_name='manpage', settings_spec=self)
    ...
    def test_citation(self):
        case_input, case_expected = citation
        output = docutils.core.publish_string(
            source=case_input,
            reader_name='standalone', parser_name='restructuredtext',
            writer_name='manpage', settings_spec=self)
    ...
    def test_rubric(self):
        case_input, case_expected = rubric
        output = docutils.core.publish_string(
            source=case_input,
            reader_name='standalone', parser_name='restructuredtext',
            writer_name='manpage', settings_spec=self)
    ...
    def test_double_quote(self):
        case_input, case_expected = double_quote
        output = docutils.core.publish_string(
            source=case_input,
            reader_name='standalone', parser_name='restructuredtext',
            writer_name='manpage', settings_spec=self)
...
.\\" Man page generated from reStructuredText.
.
''' + indend_macros + r'''.TH "DEFINITION LIST TEST"  "" "" ""
.SH NAME
Definition List Test \- 
.SS Abstract
.sp
...
cmd_line_options = ("""optional arguments:
...
citation = (""".. [docutils] blah blah blah
.. [empty_citation]
""",
        r""".\" Man page generated from reStructuredText.
.
...
double_quote = ("""in "defintion list"
